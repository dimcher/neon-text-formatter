...
let output = `${filepath}.psv`;

console.log(`Start:`, `${input}`);

const types = addon.fileTypes();

//const csv = fs.readFileSync(`${filepath}.csv`, "utf-8");
//const csv = addon.readtext(`${filepath}.csv`);
//console.log(`CSV:`, csv);
...
//s.writeFileSync(`${filepath}.tsv`, data);
//console.log(tsv);
//process.exit();
